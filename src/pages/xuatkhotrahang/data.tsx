    ...
    },
    {
      ...
      render: (text: string, record: any, index: number) => {
        return (
          ...
          >
            {roles.find((x: any) => x === "complete-order") && (
            ...
            {roles.find((x: any) => x === "create-package-debt") && (
              <Tooltip title="Xuất kho trả hàng" placement="left">
                <div
                  style={{ ...styleButton }}
                  className="addMore"
            ...
            {roles.find((x: any) => x === "print-xuat-kho-tra-hang") && (
